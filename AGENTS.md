...
1. M0 收尾（08 §2.1，2026-09-13 已按 02/03 核对）：Q2/Q22（C1 信号权重/图像信号、PWC 品类乘数公式）与 Q60（回流指标降级口径）由"临时采纳"转定稿；业务方 3 份素材已采纳销账（Q21/Q70+Q49/Q71+Q24），仅需向负责人告知留确认，不得当作"尚未采纳"重新裁决。
