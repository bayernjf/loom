...
> **当前状态**：设计/文档阶段。完整规格体系位于 [`loom-docs/`](loom-docs/)，为项目**唯一事实源**；代码尚未启动（先决事项见 [handoff.md](handoff.md) 待办区）。
...
| 文档 | 用途 |
|---|---|
| [loom-docs/README_文档地图与治理.md](loom-docs/README_文档地图与治理.md) | **文档地图（场景导航）+ 治理规则**——先读这个 |
| [handoff.md](handoff.md) | **交接文档**：当前状态、待办、活跃工作（续工时先读） |
| [loom-docs/01_PRD_产品需求规格.md](loom-docs/01_PRD_产品需求规格.md) | 权威规格：13 段链各段功能/实体/规则/硬闸 |
| [loom-docs/02_决策记录_ADR_Q1-Q72.md](loom-docs/02_决策记录_ADR_Q1-Q72.md) | 决策日志 Q1–Q72 + 配置化清单 |
| [loom-docs/04-06_契约层](loom-docs/04_契约层_数据模型.md) | 数据模型 / API 与状态机 / WF 与 Skill 协议（AI 落代码用） |
| [loom-docs/08_迭代计划与任务包.md](loom-docs/08_迭代计划与任务包.md) | 路线图（两套口径）+ M0–M10 任务包 |
...
1. **唯一事实源** = `loom-docs/` 全部文档；原 `v3.md` 已于 2026-09-13 归档删除（231 段核验零丢失）。
