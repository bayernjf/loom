...
| GET `/exports/fcw.json` | M12 中台导出 JSON 形态（Q132）：query/口径同 fcw.csv，响应 attachment JSON `{tenant_id, product_space_id, count, final_ids[]}`，未知租户空 envelope 200 | Q132/D4 |
