...
## 2. 逐表 Schema（35 设计实体；截至 2026-09-18 物理表 55 张，迁移 0001–0028；0027 纯加外键不新增表，0028 新增 content_languages 1 表）
...
> - **当前 head = 0028_content_languages**（单链线性，down_revision 逐级相扣；0001 为 root）。**0021–0028 各切片的迁移实测记录以 02 对应 C1 条目为准**（0027/0028 已实测 PG16 全链 up/down/up；0021–0026 条目不逐条复记，勿据此推断已验证）。
...
- [x] 迁移登记完整性（2026-09-17 补登、2026-09-18 续登）：迁移 **0001–0028** 均在本文登记（0001–0020 分散于各节，**0021–0028 见 §2.8 汇总补登**）；**当前 head = 0028_content_languages**；物理表 55 张（0027 纯加两外键不新增表，0028 新增 content_languages 1 表）。
