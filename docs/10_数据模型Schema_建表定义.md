...
> - **当前 head = 0039_import_jobs**（单链线性，down_revision=0038_sweep_tick_claims 逐级相扣；0001 为 root）。**0021–0039 各切片的迁移实测记录以 02 对应 C1 条目为准**（0027/0028/0029/0030/0031/0037/0038/0039 已实测 PG16 全链 up/down/up；0021–0026 条目不逐条复记，勿据此推断已验证）。
