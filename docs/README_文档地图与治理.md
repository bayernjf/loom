...
| [02_决策记录_ADR_Q1-Q72.md](./02_决策记录_ADR_Q1-Q72.md) | Part C 全量（C1 + C2） | 决策日志：Q1–Q72（v3 原文）+ Q73–Q208（持续追加，C1.17–C1.152）+ 配置化清单 | 核心 |
...
| [handoff-archive-2026-09-25.md](./handoff-archive-2026-09-25.md) | handoff 进度归档（2026-09-25 起持续续写，**共二十次**：首块为 Q176/Q177 两条完整条目原文，其后为 Q188…Q208 各批按「最近 5 条」上限滚出的条目逐字搬入，滚出对象覆盖 Q162～Q203） | 只读历史；权威逐片台账仍是 docs/02 C1 | 归档 |
